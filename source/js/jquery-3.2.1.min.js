...
!function (a, b) {
    ...
    r.extend({hasData: function (a) {
            ...
            var c = b + "queueHooks";
            return W.get(a, c) || W.access(a, c, {empty: r.Callbacks("once memory").add(function () {
    ...
    r.ajaxSetup({jsonp: "callback", jsonpCallback: function () {
        ...
        return r.grep(r.timers, function (b) {
            ...
            if (f)
                return f.getClientRects().length ? (d = f.getBoundingClientRect(), b = f.ownerDocument, c = b.documentElement, e = b.defaultView, {top: d.top + e.pageYOffset - c.clientTop, left: d.left + e.pageXOffset - c.clientLeft}) : {top: 0, left: 0}
        }, position: function () {
            if (this[0]) {
