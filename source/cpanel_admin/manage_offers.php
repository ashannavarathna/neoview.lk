...
class webpage_interface_info {
    ...
    private $_inf_name = 'Manage_Offers';
    private $_inf_code = 'CPL_MNGOFRS';
    private $_inf_url = 'cpanel/manage_offers.php';
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <form id="cpanel_login" method="post">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-addon">$</span>
                                            <input type="number" name="disc_amount" class="form-control" placeholder="Discount Amount" />
                                        </div>
                                        <br/>
                                        <div class="input-group">
                                            <span class="input-group-addon">%</span>
                                            <input type="number" name="disc_prsnt" class="form-control" placeholder="Discount Presentage" />
                                        </div>
                                        <br/>
                                        <div class="input-group">
                                            <span class="input-group-addon">:)</span>
                                            <input type="date" name="s_date" class="form-control" placeholder="Start Date" />
                                        </div>
                                        <br/>
                                        <div class="input-group">
                                            <span class="input-group-addon">:)</span>
                                            <input type="date" name="e_date" class="form-control" placeholder="End Date" />
                                        </div>
                                        <br />
                                        <div class="input-group">
                                            <span class="input-group-addon">:)</span>
                                            <textarea rows="3" class="form-control" placeholder="Offer Description"></textarea>
                                        </div>
                                        <br/>
                                        <div class="input-group">
                                            <input type="hidden" name="dataset_" value="data">
                                                <input type="submit" value="Create"  class="btn btn-success pull-right" style="width: 114px;margin-left: 200px;"/>
                                        </div>
                                    </form>
                                </div>
                                <div class="col-md-8">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td></td>
                                                <td><span class="btn btn-default btn-md ">name name name name</span></td>
                                                <td><a onclick="" class="btn btn-primary btn-xs">update / view </a></td>
                                                <td><a onclick="" class="btn btn-danger btn-xs">remove</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
